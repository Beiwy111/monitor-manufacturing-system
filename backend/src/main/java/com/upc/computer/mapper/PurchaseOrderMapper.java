...
public interface PurchaseOrderMapper {
    ...
    @Select("SELECT purchase_order_id, purchase_order_no, supplier_name, supplier_contact, supplier_phone, purchase_date, expected_arrival_date, total_amount, status, purchaser_id, approved_by, approved_at, remark, created_at, updated_at FROM purchase_order ORDER BY created_at DESC, purchase_order_id DESC")
