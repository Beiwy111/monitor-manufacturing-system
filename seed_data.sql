...
(1, 10, 'STEP-01', '面板贴附', 0.50, '贴附机', 1, 1),
(1, 20, 'STEP-02', '背光组装', 0.80, '组装线', 0, 1),
(1, 30, 'STEP-03', '整机老化测试', 4.00, '老化架', 1, 1),
(1, 40, 'STEP-04', '外观检验包装', 0.30, '包装线', 1, 1),
(2, 10, 'STEP-01', '面板贴附', 0.60, '贴附机', 1, 1),
(2, 20, 'STEP-02', '背光组装', 1.00, '组装线', 0, 1),
(2, 30, 'STEP-03', '整机老化测试', 6.00, '老化架', 1, 1),
(2, 40, 'STEP-04', '电竞调校', 1.50, '调校台', 1, 1),
(2, 50, 'STEP-05', '外观检验包装', 0.40, '包装线', 1, 1);
...
('EQ-001', '1号自动贴附机', '贴附机', '生产一部', 'A线-01', '精工自动化', 'JF-TF200', '2024-03-15', 'RUNNING', '2026-06-15 10:00:00'),
('EQ-002', '2号自动贴附机', '贴附机', '生产一部', 'A线-02', '精工自动化', 'JF-TF200', '2024-03-15', 'IDLE', '2026-06-15 10:00:00'),
('EQ-003', '1号组装流水线', '组装线', '生产一部', 'B线-01', '华南机械', 'HN-ZX100', '2023-08-20', 'RUNNING', '2026-05-20 14:00:00'),
