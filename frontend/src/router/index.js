...
const dashboardRoutes = [
  ...
  { path: 'dashboard/warehouse', name: 'DashboardWarehouse', component: () => import('@/views/dashboard/warehouse/WarehouseDashboard.vue'), meta: { title: '仓储人员首页', roleKey: 'warehouse' } },
...
const businessRoutes = [
  ...
  { path: 'warehouse/workbench', component: () => import('@/views/warehouse/WarehouseOpsWorkbench.vue'), meta: { title: '仓储管理工作台', roleKey: 'warehouse' } },
  ...
  { path: 'device/workshop-status', component: () => import('@/views/device/WorkshopStatusView.vue'), meta: { title: '生产车间状态' } },
  { path: 'device/status', redirect: '/device/workshop-status' },
  ...
  { path: 'device/records', redirect: '/device/maintenance' },
  { path: 'delivery/list', component: () => import('@/views/delivery/DeliveryView.vue'), meta: { title: '发货管理' } },
  { path: 'aftersale/work-order', component: () => import('@/views/aftersale/WorkOrderView.vue'), meta: { title: '售后工单' } },
  { path: 'aftersale/plan', component: () => import('@/views/aftersale/PlanApprovalView.vue'), meta: { title: '方案审批' } },
  { path: 'aftersale/execution', component: () => import('@/views/aftersale/ExecutionView.vue'), meta: { title: '执行协同' } },
  { path: 'aftersale/closure', component: () => import('@/views/aftersale/ClosureView.vue'), meta: { title: '验证闭环' } },
  { path: 'aftersale/case', redirect: '/aftersale/work-order' },
  { path: 'aftersale/feedback', redirect: '/aftersale/work-order' },
  { path: 'aftersale/process', redirect: '/aftersale/execution' },
  { path: 'aftersale/trace', redirect: '/dashboard/aftersale' },
  { path: 'cost/work-order', redirect: '/finance/cost-accounting' },
  { path: 'cost/material', redirect: '/finance/cost-accounting' },
  { path: 'cost/labor', redirect: '/finance/cost-accounting' },
  { path: 'cost/equipment', redirect: '/finance/cost-accounting' },
  { path: 'cost/settlement', redirect: { path: '/finance/cost-accounting', query: { tab: 'settlement' } } },
  { path: 'cost/report', redirect: '/finance/report' },
  { path: 'finance/cost-accounting', component: () => import('@/views/finance/CostAccountingView.vue'), meta: { title: '成本核算' } },
  { path: 'finance/revenue', component: () => import('@/views/finance/RevenueAccountingView.vue'), meta: { title: '收益核算' } },
  { path: 'finance/screen', component: () => import('@/views/finance/FinanceScreenView.vue'), meta: { title: '财务大屏', layout: 'screen' } },
  { path: 'finance/report', component: () => import('@/views/finance/FinanceReportView.vue'), meta: { title: '财务报表' } },
